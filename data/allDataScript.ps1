...
while ($pageNum -lt 115) {
	.\curl.exe >> C:/Users/Becca/Desktop/breweryInfo.json "http://api.brewerydb.com/v2/breweries/?key=5040cbeeac3176aa6cefa6ee079d1ff7&withLocations=Y&p=$pageNum" 
	$pageNum = $pageNum + 1
}


(Get-Content C:/Users/Becca/Desktop/breweryInfo.json) | 
Foreach-Object {$_ -replace '{"currentPage":[0-9]{1,3},"numberOfPages":114,"totalResults":5689,"data":\[', "," }| 
Set-Content C:/Users/Becca/Desktop/breweryInfo.json
